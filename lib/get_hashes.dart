...
Future<String> getTargetGeohash(double lat1, double lon1, int radiusMiles) async{
  final geohasher = GeoHasher();
...
Future<List<List<String>>> collectGeohashesInRings(double latitude, double longitude, int radiusMiles, String centerGeohash) async{
